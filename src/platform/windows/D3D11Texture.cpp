...
bool D3D11Texture::Create(const TextureDesc& desc)
{
    ...
    std::cout << std::format("Created D3D11 texture: {}x{}, format: {}, usage: {}\n", 
                             ...
                             TextureFactory::GetTextureFormatName(desc.format),
                             TextureFactory::GetTextureUsageName(desc.usage));
...
DXGI_FORMAT D3D11Texture::GetDXGIFormat(TextureFormat format) const
{
    ...
    case TextureFormat::RGB8:  return DXGI_FORMAT_R8G8B8A8_UNORM; // No direct RGB8 support
...
D3D11_USAGE D3D11Texture::GetD3D11Usage(TextureUsage usage) const
{
    ...
    case TextureUsage::Static:       return D3D11_USAGE_DEFAULT;
    case TextureUsage::RenderTarget: return D3D11_USAGE_DEFAULT;
    default:                         return D3D11_USAGE_DYNAMIC;
    }
}
...
UINT D3D11Texture::GetD3D11CPUAccessFlags(TextureUsage usage) const
{
    switch (usage)
    {
    case TextureUsage::Dynamic:      return D3D11_CPU_ACCESS_WRITE;
    case TextureUsage::Static:       return 0;
    case TextureUsage::RenderTarget: return 0;
